                                        ...
                                        <div className="row" style={{ marginTop: '2rem', padding: '2rem' }}>
                                            <div className="col-md-4">
                                                <ul className="social-links list-inline">
                                                    ...
                                                    <FacebookShareButton
                                                        url={'https://professionaldata.herokuapp.com/profile/' + this.state.id}
                                                        quote={item.title}
                                                        hashtag="#Professional_Profile"
                                                        imageUrl={"https://dev.perfectprof.com/storage/app/" + item.professional.profile_pic}
                                                    >
